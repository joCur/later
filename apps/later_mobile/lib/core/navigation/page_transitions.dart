...
import '../theme/temporal_flow_theme.dart';
...
class _SharedAxisTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final enterSlide =
        Tween<Offset>(
          ...
          CurvedAnimation(parent: animation, curve: AppAnimations.springCurve),
        );
    ...
    final gradientOverlay = _buildGradientOverlay(context, animation, isDark);
  ...
  Widget _buildGradientOverlay(
    ...
    final overlayFadeOut = Tween<double>(begin: 0.15, end: 0.0).animate(
      CurvedAnimation(
        parent: animation,
