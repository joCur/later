...
class AppColors {
  ...
  // These aliases map old color names to new Temporal Flow colors
  ...
  static const Color neutralGray200 = neutral200;
  static const Color neutralGray300 = neutral300;
  static const Color neutralGray600 = neutral600;
  static const Color neutralGray700 = neutral700;
  ...
  static const Color surfaceLightVariant = neutral100;
  static const Color surfaceDark = neutral900;
  static const Color surfaceDarkVariant = neutral800;
  ...
  static const Color textPrimaryDark = neutral400;
  ...
  // Item border colors (map to type gradients - use start color)
  ...
  // FAB gradient (use primary gradient)
